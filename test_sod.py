...
data_names = []
data_names.append('NJU2K')
data_names.append('NLPR')
data_names.append('SIP')
data_names.append('STERE')

parser = argparse.ArgumentParser()
parser.add_argument('--trainsize', type=int, default=448, help='testing size')
parser.add_argument('--pth_path', type=str, default='./checkpoints/Net_sod/Net_best_STERE.pth')
#parser.add_argument('--pth_path', type=str, default='./checkpoints/model_new/Net_best.pth')
parser.add_argument('--test_dataset_path', type=str, default='./sod/TestDataset/')
...
for _data_name in data_names:
    ...
    save_path = './res/{}_STERE_best/{}/'.format(opt.pth_path.split('/')[-2], _data_name)
