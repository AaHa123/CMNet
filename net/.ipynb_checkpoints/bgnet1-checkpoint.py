...
class UnNamedModule(nn.Module):
    def __init__(self, channel):
        ...
        self.fia1 = CAM(channel)
        self.fia2 = CAM(channel)
        self.fia3 = CAM(channel)
...
class IGM(nn.Module):
    def __init__(self, channel):
        ...
        k = t if t % 2 else t + 1
        self.conv2d = ConvBNR(channel, channel)
        self.avg_pool = nn.AdaptiveAvgPool2d(1)
...
class Net(nn.Module):
    def __init__(self,channel=64):
        ...
        self.et1 = FEHM(256, channel)
        self.et2 = FEHM(528, channel)
        self.et3 = FEHM(1024, channel)
        self.et4 = FEHM(2048, channel)
    ...
    def forward(self, x):
        ...
        #HPM+GRM = GRM
        coarse_att = self.um(t1, t2, t3, t4)
        g1 = self.igm1(t1,coarse_att)
        g2 = self.igm1(t2,coarse_att)
        g3 = self.igm1(t3,coarse_att)
        g4 = self.igm1(t4,coarse_att)
